    ...
    fetch("https://dummyjson.com/products/categories")
      ...
      .then((data) => {
        ...
        for (let i = 0; i < data.length; i++) {
          // if (data[i]?.name?.includes('womens-')) {
          //     womens.subCate.push(data[i])
          // } else if (data[i]?.name?.includes('mens-')) {
      ...
      >
        ...
        {allCategories &&
          allCategories.map((item, idx) => {
            ...
            //       <ListItemText
            //         primary={item.subCate[0].split("-")[0].toUpperCase()}
            //       />
            ...
            //               sx={{ pl: 4 }}
            //               key={item2 + idx2}
            //               onClick={() => props.changeCate(item2)}
            //             >
            //               <ListItemText
            //                 primary={item2.split("-")[1].toUpperCase()}
            //               />
            //             </ListItemButton>
            //           );
            //         })}
